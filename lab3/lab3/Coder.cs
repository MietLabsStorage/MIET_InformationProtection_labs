...
namespace lab3
{
    public class Coder
    {
        ...
        private const string DecodeOut = @"src\decode.txt";
        private const string EncodeOut = @"src\encode.bmp";
        private const string TextOut = @"src\text.txt";

        /// <summary>
        /// encode
        /// </summary>
        /// <param name="imgPath">path for coding img</param>
        ...
        /// decode
        /// </summary>
        /// <param name="encodePath">encoding file</param>
        /// <param name="decodePath">file for decode inf</param>
